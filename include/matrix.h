...
static inline bool matrix2_is_invertible(const Matrix2* m) { return matrix2_determinant(m) != 0; }
static inline bool matrix3_is_invertible(const Matrix3* m) { return matrix3_determinant(m) != 0; }
static inline bool matrix4_is_invertible(const Matrix4* m) { return matrix4_determinant(m) != 0; }
