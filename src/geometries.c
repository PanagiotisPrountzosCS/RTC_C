...
Tuple normal_at_sphere(Sphere* s, Tuple p) {
    ...
    // normals get transformed by the transpose of the inverse of s->transform
    ...
    Tuple result = matrix4_multiply_tuple(&transpose_inverse_transform, object_space_point);
